...
export default function AnalyticsPage() {
  ...
  const revenue = (x) => {
    let total;
    x.map((dat) => {return total += dat.value});
  ...
  const convertedPeople = totalLeads.filter((x) => x.status == "New");
  const percantageOfConvertedPeople = Math.trunc(
    (convertedPeople.length / totalLeads.length) * 100
  );
  ...
  const summaryMetrics = [
    {
      label: "Total Leads",
      value: totalLeads.length ? totalLeads.length : "0",
      change: "+12.5%",
      trend: "up",
      icon: Users,
    },
    ...
    <div className="h-full">
        ...
        <div className="rounded-lg border border-neutral-800 bg-neutral-900 p-6">
          <div className="mb-6 flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-neutral-400">
                Leads vs Conversions over time
              </p>
            </div>
          </div>
                  ...
                  <div className="flex-1">
                    <div className="h-8 overflow-hidden rounded bg-neutral-800">
                      <div
                        ...
                        style={{
                          width: `${
                            (item.conversions / maxConversions) * 100
                          }%`,
                        }}
                      />
                    </div>
      ...
      <div className="rounded-lg border border-neutral-800 bg-neutral-900 p-6">
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-neutral-400">
            Individual conversion rates and lead handling
          </p>
        </div>
